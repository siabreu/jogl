...
public class Cena implements GLEventListener{    
    ...
    public void iluminacaoEspecular(GL2 gl) {
        ...
        //define os parâmetros de luz de número 2 (dois)
    ...
    public void iluminacaoDifusa(GL2 gl) {
        ...
        //define os parâmetros de luz de número 1 (um)
    ...
    public void ligaPontoLuz(int numLuz, GL2 gl) {    
        // habilita a luz de número
        switch(numLuz){
            case 0:            
                iluminacaoEspecular(gl);
                System.out.println("especular");
                break;
            case 1:            
                iluminacaoDifusa(gl);
                System.out.println("difusa");
                break;
        }        
    }
